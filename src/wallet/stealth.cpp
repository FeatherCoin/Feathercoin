...
const uint8_t stealth_version_byte = 0x1e;
...
int GenerateRandomSecret(ec_secret& out)
{
    ...
    static arith_uint256 max("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364140");
    static arith_uint256 min(16000); //uint256S("0x3E80") increase? min valid key is 1
    
    uint256 test;
    arith_uint256 test_tm;
    ...
    for (i = 0; i < 32; ++i)
    {
        ...
        test_tm=UintToArith256(test);
        
        if (test_tm > min && test_tm < max)
        {
