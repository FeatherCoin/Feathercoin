...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s feathercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  feathercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded feathercoin transaction") + "\n" +
              "  feathercoin-tx [options] -create [commands]   " + _("Create hex-encoded feathercoin transaction") + "\n" +
              "\n";
