...
static void TestBlockSubsidyHalvingsMain(const Consensus::Params& consensusParams)
{
    int maxHalvings = 64;
...
BOOST_AUTO_TEST_CASE(block_subsidy_test)
{
    ...
    TestBlockSubsidyHalvingsMain(mainParams->GetConsensus());
}
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test)
{
    ...
    BOOST_CHECK_EQUAL(nSum, CAmount{33300250000000000});
}
