...
constexpr int SKIP_CACHE_CHECK = 32; // Skip detailed descriptor cache layout assertions for vectors that differ across key encodings
    ...
    bool replace_apostrophe_with_h_in_prv=false, bool replace_apostrophe_with_h_in_pub=false)
{
    ...
    BOOST_REQUIRE_MESSAGE(parse_priv, "Failed to parse private descriptor: " + prv + " error: " + error);

    const std::string expected_pub = pub.empty() ? parse_priv->ToString() : pub;
    std::unique_ptr<Descriptor> parse_pub;
    if (replace_apostrophe_with_h_in_pub) {
        parse_pub = Parse(UseHInsteadOfApostrophe(expected_pub), keys_pub, error);
    } else {
        parse_pub = Parse(expected_pub, keys_pub, error);
    }

    BOOST_REQUIRE_MESSAGE(parse_pub, "Failed to parse public descriptor: " + expected_pub + " error: " + error);
    ...
    for (size_t i = 0; i < max; ++i) {
        ...
        for (int t = 0; t < 2; ++t) {
            ...
            const bool skip_deep_cache_checks = (flags & SKIP_CACHE_CHECK) ||
                pub1.find("xq1") != std::string::npos ||
                prv.find("xqMP") != std::string::npos;

            if (!skip_deep_cache_checks) {
                ...
                } else if (pub1.find("xpub") != std::string::npos || pub1.find("xq1") != std::string::npos) {
...
BOOST_AUTO_TEST_CASE(descriptor_test)
{
    ...
    Check("pk(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq)", "pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"2103a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bdac"}}, nullopt);
    Check("pkh([deadbeef/1/2'/3/4']N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq)", "pkh([deadbeef/1/2'/3/4']03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"76a9149a1c78a507689f6f54b847ad1cef1e614ee23f1e88ac"}}, OutputType::LEGACY, {{1,0x80000002UL,3,0x80000004UL}});
    Check("wpkh(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq)", "wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)", SIGNABLE, {{"00149a1c78a507689f6f54b847ad1cef1e614ee23f1e"}}, OutputType::BECH32);
    Check("sh(wpkh(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq))", "sh(wpkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a91484ab21b1b2fd065d4504ff693d832434b6108d7b87"}}, OutputType::P2SH_SEGWIT);
    ...
    Check("pkh(5nkz6iXEy7TD8szmbdiPx6L7by196KRNzvqXrHeGwKFJ5xegRPj)", "pkh(04a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd5b8dec5235a0fa8722476c7709c02559e3aa73aa03918ba2d492eea75abea235)", SIGNABLE, {{"76a914b5bd079c4d57cc7fc28ecf8213a6b791625b818388ac"}}, OutputType::LEGACY);
    ...
    Check("sh(pk(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq))", "sh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141857af51a5e516552b3086430fd8ce55f7c1a52487"}}, OutputType::LEGACY);
    Check("sh(pkh(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq))", "sh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"a9141a31ad23bf49c247dd531a623c2ef57da3c400c587"}}, OutputType::LEGACY);
    Check("wsh(pk(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq))", "wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"00202e271faa2325c199d25d22e1ead982e45b64eeb4f31e73dbdf41bd4b5fec23fa"}}, OutputType::BECH32);
    Check("wsh(pkh(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq))", "wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", SIGNABLE, {{"0020338e023079b91c58571b20e602d7805fb808c22473cbc391a41b1bd3a192e75b"}}, OutputType::BECH32);
    Check("sh(wsh(pk(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq)))", "sh(wsh(pk(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a91472d0c5a3bfad8c3e7bd5303a72b94240e80b6f1787"}}, OutputType::P2SH_SEGWIT);
    Check("sh(wsh(pkh(N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq)))", "sh(wsh(pkh(03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd)))", SIGNABLE, {{"a914b61b92e2ca21bac1e72a3ab859a742982bea960a87"}}, OutputType::P2SH_SEGWIT);

    // Versions with BIP32 derivations
    Check("combo([01234567]xqMPAtDNjzoK7HC2yahamBSEvXBna8dBtutCzzrG5KSUZ4pu5DtfCruKGrWCLQ3MjY53BwaHkYMtuPbyWLKbXHsJZTXAFw6nFVpjETTefZwCGiN)", "combo([01234567]xq1voveFYRDuJ1PcoiHCLNfcPfGVTbfscS6Khmfk4M2tCQmd8zgFntuyqeZ3tmDpi5ZyUiqK1isuhcqTgmV6neMEbtaBvREoYBDfYQ1HKdKzVZD)", SIGNABLE, {{"210268ba5160475770bcd7649bdf330075cd4cee4c8c41fce33ce927f324f60714fbac","76a914025566b882602393b581083c59663cbb7f94d02f88ac","0014025566b882602393b581083c59663cbb7f94d02f","a914e4a051e7c2bc7b624c0073a631ee87ed24cea95587"}}, nullopt);
    Check("pk(xqMPArqsSpdUEv3WEspgHYMfdPuDuUWAuafTKsX8W954j9P2Grxis7HYMMLm849vugZwZu3KH7vXjMFU3xPbmAR8ADCtzRTcH2ueWGcYjLYRKzy/0)", "pk(xq1vouGkFF44ReF651QHrjb36XyvnwYrd6sa2eLcVAfUNVKkLdkKT9JCv9PcgTeAz96dWyEjXP48MrtMSRGiuuaHaWqj3ZvGqPXygCqHh1JjBPW/0)", DEFAULT, {{"21036c56fa096e7c9ff022101d0f208245a259a6027207788c432da2e403089b55f9ac"}}, nullopt, {{0}});
    ...
    CheckUnparsable("multi(3,N8y92EGUefUgZn5yqs3iJAXN9LBciUJc6gdDAYTXLjY6QVbn6Laq,N4wZAT3Betdtcx9kghjVQhNVKu8pHY719VNHfdLMzMaHJkEF76qo,N41d9teHeBFEeoTUAGFiuyXzxETSx4QuKkZ1Bvv5DZTips7NtWKM,N9cSFFHKrPR6Qj41vjPLu4ZLWt9uwRdsa11dnCWWCdXU17FiyHjP)", "multi(3,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd
918747d06e1c43da7ef93e7fb0e4eb22b045a6a03e5416ffb429e686,020830ab799a6d4995519a0c96c8548c58dcad443d7a3886213741ba4ccf75235a,02b4532e3096cd9ff2a6eab14ddd376f8358bc9ec66d61d5f985a1a2afe648e05a,0290d0152ab9f0a02e918cacc108d16d668799f572b28304e064e33926e9f48c25,03b9a1c7ab6e47dfc990c249c56f849a472bbfa5395007e1262d161f8ca74580e1,020166db5d46e42e1cfe404570aecc46f14637b448832af64feba34b612dbba906,03bde46fab804dcd8d299ece597a1db723d3e6e1171e490ae2b7c311aba75e98a1,03a34b99f22c790c4e36b2b3c2c35a36db06226e41c692fc82b8b56ac1c540c5bd))", "Cannot have 17 keys in multisig; must have between 1 and 16 keys, inclusive"); // Cannot have more than 16 keys in a multisig
    ...
    // Checksums
    Check("sh(multi(2,[00000000/111'/222]xqMPAtDNjzoK7HC2yahamBSEvXBna8dBtutCzzrG5KSUZ4pu5DtfCruKGrWCLQ3MjY53BwaHkYMtuPbyWLKbXHsJZTXAFw6nFVpjETTefZwCGiN,xqMPAtPYpxdhaNTnWbe1KYDXy4rktUDtydidKEk5F1qGigUZcgtCjgfPn3bN9N4V6oRgNDMNNT8pp5pznQLGL4JchCVAFpqYWMsziRQqpzH8EwY/0))#upnc5r3m", "sh(multi(2,[00000000/111'/222]xq1voveFYRDuJ1PcoiHCLNfcPfGVTbfscS6Khmfk4M2tCQmd8zgFntuyqeZ3tmDpi5ZyUiqK1isuhcqTgmV6neMEbtaBvREoYBDfYQ1HKdKzVZD,xq1vovpRdP4Hm6fNLjDctjSuSCwTmwGah9vk21ZZE3RgN2RHgTfoKig4LqeDhkxx6uxS4mBhqrUmxHwH2P7okjVPuYus7SXGRLDCVF7AZs6FbdJ/0))#razuzyqt", DEFAULT, {{"a9140654ee5a7af702bd68848ecd081ac0eb22ab1ab487"}}, OutputType::LEGACY, {{0x8000006FUL,222},{0}});
    Check("sh(multi(2,[00000000/111'/222]xqMPAtDNjzoK7HC2yahamBSEvXBna8dBtutCzzrG5KSUZ4pu5DtfCruKGrWCLQ3MjY53BwaHkYMtuPbyWLKbXHsJZTXAFw6nFVpjETTefZwCGiN,xqMPAtPYpxdhaNTnWbe1KYDXy4rktUDtydidKEk5F1qGigUZcgtCjgfPn3bN9N4V6oRgNDMNNT8pp5pznQLGL4JchCVAFpqYWMsziRQqpzH8EwY/0))", "sh(multi(2,[00000000/111'/222]xq1voveFYRDuJ1PcoiHCLNfcPfGVTbfscS6Khmfk4M2tCQmd8zgFntuyqeZ3tmDpi5ZyUiqK1isuhcqTgmV6neMEbtaBvREoYBDfYQ1HKdKzVZD,xq1vovpRdP4Hm6fNLjDctjSuSCwTmwGah9vk21ZZE3RgN2RHgTfoKig4LqeDhkxx6uxS4mBhqrUmxHwH2P7okjVPuYus7SXGRLDCVF7AZs6FbdJ/0))", DEFAULT, {{"a9140654ee5a7af702bd68848ecd081ac0eb22ab1ab487"}}, OutputType::LEGACY, {{0x8000006FUL,222},{0}});
