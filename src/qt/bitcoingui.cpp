...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(TextColorIcon(":/icons/about"), tr("&About Feathercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Feathercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Feathercoin Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Feathercoin Core client") + " " + networkStyle->getTitleAddText();
