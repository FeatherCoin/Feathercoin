...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Feathercoin",
    ...
    QApplication::setOrganizationName("Feathercoin");
    QApplication::setOrganizationDomain("feathercoin.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Feathercoin-Qt-testnet");
    else
        QApplication::setApplicationName("Feathercoin-Qt");
