...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelMainLogo = new QLabel(OverviewPage);
        labelMainLogo->setObjectName(QStringLiteral("labelMainLogo"));
        labelMainLogo->setPixmap(QPixmap(QString::fromUtf8(":/images/logo")));

        verticalLayout_2->addWidget(labelMainLogo);
