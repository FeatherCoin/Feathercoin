...
public:
    ...
    QFrame *StatusBarDividerLine;

    void setupUi(QWidget *OverviewPage)
    {
        if (OverviewPage->objectName().isEmpty())
            OverviewPage->setObjectName(QStringLiteral("OverviewPage"));
        OverviewPage->resize(573, 388);
        QIcon icon;
        ...
        labelBalance->setText(QStringLiteral("0 FTC"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 FTC"));
        ...
        labelImmature->setText(QStringLiteral("0 FTC"));
        ...
        labelTotal->setText(QStringLiteral("0 FTC"));
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/images/mainlogo")));
        label_2->setIndent(0);
        ...
        StatusBarDividerLine = new QFrame(OverviewPage);
        StatusBarDividerLine->setObjectName(QStringLiteral("StatusBarDividerLine"));
        StatusBarDividerLine->setFrameShadow(QFrame::Raised);
        StatusBarDividerLine->setLineWidth(1);
        StatusBarDividerLine->setFrameShape(QFrame::HLine);

        topLayout->addWidget(StatusBarDividerLine, 0, Qt::AlignBottom);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Feathercoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Feathercoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
