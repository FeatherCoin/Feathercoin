...
public:
    ...
    void setupUi(QDialog *HelpMessageDialog)
    {
        ...
        HelpMessageDialog->resize(800, 327);
        QFont font;
        ...
        horizontalLayout_2->addWidget(graphic, 0, Qt::AlignBottom);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 665, 269));
    ...
    {
        HelpMessageDialog->setWindowTitle(QApplication::translate("HelpMessageDialog", "Feathercoin Core - Command-line options", 0));
    } // retranslateUi
