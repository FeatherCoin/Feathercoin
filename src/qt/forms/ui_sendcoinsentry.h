...
public:
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        checkSmart = new QCheckBox(SendCoins);
        checkSmart->setObjectName(QStringLiteral("checkSmart"));

        horizontalLayoutAmount->addWidget(checkSmart);

        heightEdit = new QLineEdit(SendCoins);
        heightEdit->setObjectName(QStringLiteral("heightEdit"));
        heightEdit->setEnabled(false);

        horizontalLayoutAmount->addWidget(heightEdit);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Bitcoin address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less feathercoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", 0));
#endif // QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setText(QApplication::translate("SendCoinsEntry", "S&ubtract fee from amount", 0));
        checkSmart->setText(QApplication::translate("SendCoinsEntry", "Smart Contract", 0));
        heightEdit->setText(QApplication::translate("SendCoinsEntry", "1484594", 0));
        messageLabel->setText(QApplication::translate("SendCoinsEntry", "Message:", 0));
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the feathercoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Bitcoin network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
