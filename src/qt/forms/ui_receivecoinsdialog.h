...
public:
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        ReceiveCoinsDialog->resize(776, 409);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("../res/icons/qrcode.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        lineStatusBarDivide = new QFrame(ReceiveCoinsDialog);
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Feathercoin network.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Feathercoin network.", 0));
#endif // QT_NO_TOOLTIP
