...
const char* BIP71_MIMETYPE_PAYMENT = "application/feathercoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/feathercoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/feathercoin-paymentrequest";
