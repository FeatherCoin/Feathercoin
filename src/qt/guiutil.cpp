...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Feathercoin address (e.g. %1)").arg("6op3tGBzHnr7NBEjNiVFEmYY3Xpu1m2duW"));
#endif
...
boost::filesystem::path static StartupShortcutPath()
{
    if (GetBoolArg("-testnet", false))
        ...
        return GetSpecialFolderPath(CSIDL_STARTUP) / "Feathercoin (regtest).lnk";
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (GetBoolArg("-testnet", false))
            optionFile << "Name=Feathercoin (testnet)\n";
        else if (GetBoolArg("-regtest", false))
            optionFile << "Name=Feathercoin (regtest)\n";
        else
