...
*Setup instructions for a Gitian build of Feathercoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Feathercoin
...
- [Building Feathercoin Core](#building-bitcoin-core)
...
To build Feathercoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
