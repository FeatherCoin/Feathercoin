Feathercoin Core version 0.9.6.2 is now available 
...
New in 0.9.x is the Windows 64-bit version of the client. There have been
...
In the final 0.9.x release, Windows setup.exe binaries will be code-signed.
