...
from test_framework.messages import CInv, msg_getdata, msg_verack, NODE_NETWORK_LIMITED, NODE_WITNESS, NODE_ACP
...
class NodeNetworkLimitedTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(node1.firstAddrnServices, 16778248)
