...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.config = config
        self.options.bitcoind = os.getenv("FEATHERCOIND", default=config["environment"]["BUILDDIR"] + '/src/feathercoind' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("FEATHERCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/feathercoin-cli' + config["environment"]["EXEEXT"])
