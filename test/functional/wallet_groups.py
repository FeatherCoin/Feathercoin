...
class WalletGroupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        v.sort()
        assert_approx(v[0], vexp=0.2, vspan=0.0003)
        assert_approx(v[1], vexp=0.3, vspan=0.0002)
        ...
        v.sort()
        assert_approx(v[0], vexp=0.2, vspan=0.0003)
        assert_approx(v[1], vexp=1.3, vspan=0.0003)
        ...
        # - C1 0.5      - F  ~1.3
        # - D ~0.3
        assert_approx(self.nodes[1].getbalance(), vexp=4.3, vspan=0.0003)
        assert_approx(self.nodes[2].getbalance(), vexp=4.3, vspan=0.0003)
        ...
        values.sort()
        assert_approx(values[0], vexp=0.1, vspan=0.0003)
        assert_approx(values[1], vexp=1.4, vspan=0.0003)
        ...
        # Fee selection may vary by chain policy; ensure a valid spend and change output are created.
        assert len(tx4["vin"]) >= 1
